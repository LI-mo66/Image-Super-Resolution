#!/usr/bin/env python3
"""Compare N7's first 20 scratch epochs with the existing 150-epoch baseline."""
import argparse
...
def main():
    ...
    print(
        f'cross_axis | {candidate_psnr[19]:.6f} | {candidate_psnr.max():.6f} | '
        f'{candidate_tail:.6f} | '
